...
CREATE TABLE sensor_alerts (
  id         int(11), 
  id_prefix  datetime(5) DEFAULT ale- NOT NULL, 
  sensor_id  int(11) NOT NULL, 
...
ALTER TABLE announcements AUTO_INCREMENT = 99999;
ALTER TABLE sensor_alerts AUTO_INCREMENT = 99999;
ALTER TABLE users AUTO_INCREMENT = 99999;
ALTER TABLE access_points AUTO_INCREMENT = 99999;
ALTER TABLE miners AUTO_INCREMENT = 99999;
ALTER TABLE logs AUTO_INCREMENT = 99999;
ALTER TABLE areas AUTO_INCREMENT = 99999;
ALTER TABLE measurements AUTO_INCREMENT = 99999;
ALTER TABLE access AUTO_INCREMENT = 99999;
ALTER TABLE sensors AUTO_INCREMENT = 99999;